...
@section('content')
    ...
    <section class="content-header">
        <h1 style="font-weight: 600;">Manage Super Admin</h1>
    </section>
                    ...
                    <div class="box-header">
                        <div class="row">
                            <div class="toolbar col-sm-2">
                                <button type="button" class="btn btn-block btn-danger btn-sm" data-toggle="modal" data-target="#modal-add" style="max-width: 150px;">
                                    <span class="glyphicon glyphicon-plus-sign"></span> Add Super Admin
                                </button>
